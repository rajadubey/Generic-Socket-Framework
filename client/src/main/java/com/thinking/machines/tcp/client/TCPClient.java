...
private int portNumbepackage com.thinking.machines.tcp.client;
import java.net.*;
import java.io.*;
import com.thinking.machines.common.pojo.*;
import com.thinking.machines.tcp.common.*;
...
client.setId(uuid);
client.setIP(socketForSendingRequest.getRemoteSocketAddress().toString());
...
while(true)
{
if(outgoingRequestProcessor!=null)
{
System.out.println("outgoingRequestProcessor is not null");
break;
}
}
