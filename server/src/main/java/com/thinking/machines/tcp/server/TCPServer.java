...
{
private ServerSocket incomingRequestServpackage com.thinking.machines.tcp.server;
import java.io.*;
import com.thinking.machines.tcp.common.event.*;
import com.thinking.machines.tcp.common.pojo.*;
import com.thinking.machines.tcp.common.*;
...
int uuidSize=is.read(uuidBytes);
byte ack[]=new byte[1];
ack[0]=100;
os.write(ack);
os.flush();
...
System.out.println("TCPServer ki send call hue h");
